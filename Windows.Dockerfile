...
RUN powershell.exe Invoke-WebRequest -Uri https://github.com/Zer1Ic3/basic_powershell/blob/main/Add_user_admin_group.ps1 -OutFile c:\\Users\Shelly\Documents\addusers_admingroup.ps1 
